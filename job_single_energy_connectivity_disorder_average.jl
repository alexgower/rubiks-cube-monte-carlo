...
include("code/experiments/connections_experiment.jl")
...
special_sample_temperature = collect(LinRange(0.7,1.5,50))
sample_temperatures = vcat(sample_temperatures, special_sample_temperature)
sort!(sample_temperatures, rev=true)

connections_experiment("$(extra_save_name)_$(i)_disorder_average_connections_L=$(L_value)_inherent_disorder_E0_E1_slice", L_value, 1.0, 5, 
        ...
        initial_cube_configuration=nothing, parallel_anneals=1, disorder_average=true)
