...
special_sample_temperature = collect(LinRange(0.3,0.8,100))
...
@sync @distributed for L_value in L_values
    neighbour_experiment("saddle_index_densities_L=$(L_value)_slice_new", L_value, 1.0, 5, sample_temperatures; relaxation_iterations=10000,  collecting_swap_move_neighbours=false, neighbours_per_configuration_sample_size=0, average_sample_size_per_temperature=1000, parallel_anneals=number_of_processors_per_L_value, initial_cube_configuration=starting_configurations[Int((L_value-3)/2)], collect_energy_connections=false)
end
