...
connections_experiment("$(extra_save_name)_disorder_average_connections_L=$(L_value)_inherent_disorder_E0_E1_slice", L_value, 1.0, 5, 
        sample_temperatures; relaxation_iterations=10000, connections_to_measure="slice", 
        connections_per_configuration_sample_size=0, neighbour_order_to_measure_to=1, average_sample_size_per_temperature=100, 
        initial_cube_configuration=nothing, parallel_anneals=number_of_processors, disorder_average=true)
