...
@sync @distributed for L_value in L_values
    relaxed_anneal_experiment("relaxed_anneal_L=$L_value", L_value, [1.0,0.0], 10.0,10.0,0.1,100; inherent_disorder=true, relaxation_iterations=10000, initial_cube_configuration=starting_configurations[Int((L_value-3)/2)])
end