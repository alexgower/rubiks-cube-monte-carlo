...
@inbounds @fastmath function history_anneal_experiment(simulation_name::String, L::Int64, swap_move_probabilities::Vector{Float64}, T_swap::Float64, T_1::Float64, T_0::Float64, N_T::Int64; verbose_metropolis_swap::Bool=false, normalization::String="solved")
    ...
    # Notes ---
    # - We accept a cube as an input so we can easily do a history anneal after a relaxed anneal on the same cube
    ...
    try
        ...
        for (index,swap_move_probability) in pairs(swap_move_probabilities)
            ...
            try
                ...
                touch(joinpath("results/history_anneal_results",simulation_name_to_use))

                open(joinpath("results/history_anneal_results",simulation_name_to_use), "w") do simulation_file
        ...
        try
            ...
            if isfile(joinpath("results/history_anneal_results","other_data.csv"))

                data_matrix = readdlm(joinpath("results/history_anneal_results","other_data.csv"), ',', Float64, '\n', skipstart=0)
            ...
            savefig(graph, "results/history_anneal_results/$simulation_name.png")
