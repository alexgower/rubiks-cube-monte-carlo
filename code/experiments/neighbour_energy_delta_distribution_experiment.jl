...
@inbounds @fastmath function neighbour_energy_deltas_distribution_experiment(simulation_name::String, L::Int64, swap_move_probability::Float64, N_T::Int64, neighbour_sample_temperatures::Vector{Float64}, average_sample_size_per_temperature::Int64; verbose_metropolis_swap::Bool=false, normalization::String="solved", relaxation_iterations::Int64=Int(0), mixing_p_swap::Float64=0.0, collecting_swap_move_neighbours::Bool=false, neighbours_per_configuration_sample_size::Int64=0, collect_minimum_neighbour_energy_info_only::Bool=false)
    ...
    for (index,sample_temperature) in pairs(neighbour_sample_temperatures)
        ...
        try
            ...
            open(joinpath("results/neighbour_energy_deltas_distribution_results",data_simulation_name_to_use), "w") do simulation_file
                write(simulation_file, "Simulation:L=$L, P_s=$swap_move_probability, T_swap=$T_swap, T_1=$T_1, T_0=$T_0, N_T=$N_T, Trials=$(average_sample_size_per_temperature), Neighbours Per Configuration Sample Size=$(neighbours_per_configuration_sample_size), Collecting Swap Move Neighbours = $(collecting_swap_move_neighbours) \n")
