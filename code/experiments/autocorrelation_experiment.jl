...
@inbounds @fastmath function autocorrelation_experiment(simulation_name::String, L::Int64, swap_move_probability::Float64, T_1::Float64, T_0::Float64, N_T::Int64, sample_temperatures::Vector{Float64}, relaxation_iterations_per_temperature::Int64, average_sample_size_per_temperature::Int64, autocorrelation_window_length::Int64; verbose_annealing::Bool=false, verbose_metropolis_swap::Bool=true, verbose_graph_annealing::Bool=false, original_configuration::Union{Vector{Matrix{Int64}},Nothing}=nothing, inherent_disorder_average::Bool=false, parallel_anneals::Int64=1, bin_autocorrelation_averages_by_time::Bool=false, lag_limit::Int64=100)
    ...
    filename = simulation_name * '_' * string(swap_move_probability) * "_energy_taus.csv"
    ...
    open(joinpath("results/autocorrelation_anneal_results",filename), "w") do simulation_file
        write(simulation_file, "Simulation:L=$L, P_s=$swap_move_probability, T_1=$T_1, T_0=$T_0, N_T=$N_T, autocorrelation_sample_size_per_temperature=$(average_sample_size_per_temperature) ,autocorrelation_window_length=$autocorrelation_window_length \n")
        if !isnothing(original_configuration)
    ...
    filename = simulation_name * '_' * string(swap_move_probability) * "_energy_betas.csv"
    ...
    filename = simulation_name * '_' * string(swap_move_probability) * "_configuration_taus.csv"
    ...
    filename = simulation_name * '_' * string(swap_move_probability) * "_configuration_betas.csv"
    ...
    if !bin_autocorrelation_averages_by_time
        ...
        filename = simulation_name * '_' * string(swap_move_probability) * "_energy_autocorrelation_averages_by_time.csv"
        ...
        filename = simulation_name * '_' * string(swap_move_probability) * "_configuration_autocorrelation_averages_by_time.csv"
