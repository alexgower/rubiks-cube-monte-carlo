...
# TODO: possibly integrate energy/order parameter histories in MC program
# TODO: add average order parameter and order parameter squared alongside average energy measurement
...
@inbounds @fastmath function swap_prob_anneal_experiment(simulation_name::String, L::Int64, swap_move_probabilities::Vector{Float64}, T_swap::Float64, T_1::Float64, T_0::Float64, N_T::Int64; verbose_metropolis_swap::Bool=false)
    ...
    try
        ...
        for (index,swap_move_probability) in pairs(swap_move_probabilities)
            ...
            push!(alternative_normalised_E_average_by_temperature,-E_average_by_temperature./infinite_temperature_energy(cube))
